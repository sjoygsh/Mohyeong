...
class UpdatesViewData extends DataClass {
  ...
  factory UpdatesViewData.fromJson(Map<String, dynamic> json,
    ...
    return UpdatesViewData(
      ...
      excludedScanlator:
          serializer.fromJson<String?>(json['excludedScanlator']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'excludedScanlator': serializer.toJson<String?>(excludedScanlator),
    };
  }

  UpdatesViewData copyWith(
          {int? mangaId,
          String? mangaTitle,
          int? chapterId,
          String? chapterName,
          ...
          int? dateUpload,
          int? datefetch,
          Value<String?> excludedScanlator = const Value.absent()}) =>
      UpdatesViewData(
        mangaId: mangaId ?? this.mangaId,
        ...
        dateUpload: dateUpload ?? this.dateUpload,
        datefetch: datefetch ?? this.datefetch,
        excludedScanlator: excludedScanlator.present
            ? excludedScanlator.value
            : this.excludedScanlator,
      );
  @override
  String toString() {
    return (StringBuffer('UpdatesViewData(')
          ...
          ..write('dateUpload: $dateUpload, ')
          ..write('datefetch: $datefetch, ')
          ..write('excludedScanlator: $excludedScanlator')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is UpdatesViewData &&
          ...
          other.dateUpload == this.dateUpload &&
          other.datefetch == this.datefetch &&
          other.excludedScanlator == this.excludedScanlator);
}

class UpdatesView extends ViewInfo<UpdatesView, UpdatesViewData>
  ...
  @override
  UpdatesViewData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return UpdatesViewData(
      mangaId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}mangaId'])!,
      mangaTitle: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}mangaTitle'])!,
      chapterId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}chapterId'])!,
      chapterName: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}chapterName'])!,
      scanlator: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}scanlator']),
      chapterUrl: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}chapterUrl'])!,
      read: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}read'])!,
      bookmark: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}bookmark'])!,
      ...
      coverLastModified: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}coverLastModified'])!,
      dateUpload: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}dateUpload'])!,
      datefetch: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}datefetch'])!,
      excludedScanlator: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}excludedScanlator']),
    );
  }
  ...
  late final GeneratedColumn<String> chapterName = GeneratedColumn<String>(
      'chapterName', aliasedName, false,
      type: DriftSqlType.string);
  late final GeneratedColumn<String> scanlator = GeneratedColumn<String>(
      'scanlator', aliasedName, true,
      type: DriftSqlType.string);
  late final GeneratedColumn<String> chapterUrl = GeneratedColumn<String>(
      'chapterUrl', aliasedName, false,
      type: DriftSqlType.string);
  late final GeneratedColumn<int> read =
      GeneratedColumn<int>('read', aliasedName, false, type: DriftSqlType.int);
  late final GeneratedColumn<int> bookmark = GeneratedColumn<int>(
      'bookmark', aliasedName, false,
      type: DriftSqlType.int);
  late final GeneratedColumn<int> lastPageRead = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<String> thumbnailUrl = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string);
  late final GeneratedColumn<int> coverLastModified = GeneratedColumn<int>(
      'coverLastModified', aliasedName, false,
      type: DriftSqlType.int);
  late final GeneratedColumn<int> dateUpload = GeneratedColumn<int>(
      'dateUpload', aliasedName, false,
      type: DriftSqlType.int);
  late final GeneratedColumn<int> datefetch = GeneratedColumn<int>(
      'datefetch', aliasedName, false,
      type: DriftSqlType.int);
  late final GeneratedColumn<String> excludedScanlator =
      GeneratedColumn<String>('excludedScanlator', aliasedName, true,
          type: DriftSqlType.string);
  @override
...
class LibraryViewData extends DataClass {
  final int id;
  final int source;
  final String url;
  final String? artist;
  ...
  factory LibraryViewData.fromJson(Map<String, dynamic> json,
    ...
    return LibraryViewData(
      ...
      latestUpload: serializer.fromJson<int>(json['latestUpload']),
      chapterFetchedAt: serializer.fromJson<int>(json['chapterFetchedAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'latestUpload': serializer.toJson<int>(latestUpload),
      'chapterFetchedAt': serializer.toJson<int>(chapterFetchedAt),
...
class LibraryView extends ViewInfo<LibraryView, LibraryViewData>
    implements HasResultSet {
  final String? _alias;
  @override
  final _$AppDatabase attachedDatabase;
  ...
  LibraryViewData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LibraryViewData(
      ...
      totalCount: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}totalCount'])!,
      readCount: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}readCount'])!,
      latestUpload: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}latestUpload'])!,
      chapterFetchedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}chapterFetchedAt'])!,
      lastRead: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}lastRead'])!,
      bookmarkCount: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}bookmarkCount'])!,
  ...
  late final GeneratedColumn<int> id =
      GeneratedColumn<int>('_id', aliasedName, false, type: DriftSqlType.int);
  late final GeneratedColumn<int> source = GeneratedColumn<int>(
      'source', aliasedName, false,
      type: DriftSqlType.int);
  late final GeneratedColumn<String> url = GeneratedColumn<String>(
  ...
  late final GeneratedColumn<int> readCount = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int);
  late final GeneratedColumn<int> latestUpload = GeneratedColumn<int>(
      'latestUpload', aliasedName, false,
      type: DriftSqlType.int);
  late final GeneratedColumn<int> chapterFetchedAt = GeneratedColumn<int>(
      'chapterFetchedAt', aliasedName, false,
      type: DriftSqlType.int);
  late final GeneratedColumn<int> lastRead = GeneratedColumn<int>(
      'lastRead', aliasedName, false,
      type: DriftSqlType.int);
